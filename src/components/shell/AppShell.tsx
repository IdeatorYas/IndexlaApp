...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-app-bg text-app-ink">
      ...
      <div
        className={[
          "fixed inset-y-0 left-0 z-50 w-[260px] transform transition-transform duration-200 lg:static lg:translate-x-0",
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="flex-1 px-4 py-5 sm:px-5 lg:px-7 lg:py-6">
          {children}
        </main>
      </div>
    </div>
