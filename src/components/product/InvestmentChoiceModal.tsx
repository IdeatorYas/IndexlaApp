...
export function InvestmentChoiceModal({
  ...
  return (
    ...
    >
      <div className="w-full max-w-md overflow-hidden rounded-[16px] border border-app-brand/30 bg-gradient-to-b from-app-elevated to-app-panel shadow-[0_24px_80px_-20px_rgba(59,130,246,0.45)]">
        <div className="border-b border-app-line/60 bg-gradient-to-r from-app-brand/12 to-[color:var(--color-accent-violet)]/10 px-4 py-3">
          <p className="text-[10px] font-bold uppercase tracking-wider text-app-brand">
        ...
        <div className="space-y-2 p-3">
          <button
            type="button"
            className="w-full rounded-[12px] border border-app-brand/40 bg-gradient-to-r from-app-brand/20 to-[color:var(--color-accent-cyan)]/15 p-3 text-left transition hover:border-app-brand/60"
            onClick={() =>
              router.push(`${APP_ROUTES.create}?from=${productId}&mode=published`)
            }
          >
            <p className="text-sm font-bold text-app-ink">Invest as Published</p>
          ...
          <button
            type="button"
            className="w-full rounded-[12px] border border-app-line bg-app-elevated/80 p-3 text-left transition hover:border-app-brand/30"
            onClick={() =>
              router.push(`${APP_ROUTES.create}?from=${productId}&mode=customize`)
            }
          >
            <p className="text-sm font-bold text-app-ink">Customize First</p>
            <p className="mt-0.5 text-[11px] text-app-muted">
